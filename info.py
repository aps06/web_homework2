    ...
    def __init__(self, value=''):
        while True:
            ...
            if value:
                ...
                self.values = cli.input("Phones(+48......... or +38..........) (multiple phones can be added with space between them. +48 pattern has 9 symbols after code): ")
            try:
                ...
                cli.print('Incorrect phone number format! Please provide correct phone number format.')
            else:
                break
    ...
    def __init__(self, value=''):
        while True:
            if value:
                ...
                self.value = cli.input("Birthday date(dd/mm/YYYY): ")
            try:
                ...
                cli.print('Incorrect date! Please provide correct date format.')
    ...
    def __init__(self, value=''):
        while True:
            ...
            try:
                ...
                cli.print('Incorrect email! Please provide correct email.')
    ...
    def __init__(self, value=''):
        while True:
            ...
            if value:
                ...
                self.value = cli.input("Type of relationship (family, friend, work): ")
            try:
                ...
                cli.print('There is no such status!')
